...
```sh
/Users/sozercan/projects/kindctl/bin/kindctl kubectl get nodes
/Users/sozercan/projects/kindctl/bin/kindctl exec -- helm list
```
...
make install-cli     # optional: symlink bin/kindctl to ~/.local/bin/kindctl
```
...
```sh
/Users/sozercan/projects/kindctl/bin/kindctl <command>
```
